...
export const projectsData = [
	{
		...
		ProjectInfo: {
			...
			// 		name: 'Twitter',
			// 		icon: <FiTwitter />,
			// 		url: 'https://x.com/mamahhakutakut',
			// 	},
			// 	{
			// 		id: uuidv4(),
			// 		name: 'Instagram',
			// 		icon: <FiInstagram />,
			// 		url: 'https://instagram.com/yogardkaa',
			// 	},
			// 	{
			// 		id: uuidv4(),
			// 		name: 'Facebook',
			// 		icon: <FiFacebook />,
			// 		url: 'https://facebook.com/profile.php?id=100009091047163&mibextid=ZbWKwL',
			// 	},
			// 	{
			// 		id: uuidv4(),
			// 		name: 'LinkedIn',
			// 		icon: <FiLinkedin />,
			// 		url: 'https://linkedin.com/agooy',
			// 	},
			// 	{
			// 		id: uuidv4(),
			// 		name: 'Youtube',
			// 		icon: <FiYoutube />,
			// 		url: 'https://www.youtube.com/@Agooy-',
			// 	},
			// ],
		},
	},
